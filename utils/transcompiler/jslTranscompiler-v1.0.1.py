...
namespaceName = "AtlasProject"
buildFileName = "AtlasProject-v0.0.0.js"
...
def compileClass( file, className ):
	...
	for line in file:
		...
		# Convert static property identifiers to MyClass.myStaticProperty
		for staticMember in staticMembers:
			line = line.replace( "static." + staticMember, className + "." + staticMember )
		
		# If line is class constructor
		if line.startswith( classConstructorKeyword ):
			line = line.replace( classConstructorKeyword, "/*constructor*/ function " + className )
			print( line )
		...
		# If line is static property
			...
			memberName = line[ memberNameStartIndex : memberNameEndIndex ]
			print( memberName )
			staticMembers.append( memberName )
		...
		# If line is static method
			...
			line = line.replace( staticMethodKeyword + " " + memberName, className + "." + memberName + " = function" )
		...
		# If line is instance method
			...
			line = line.replace( instanceMethodKeyword + " " + memberName, className + ".prototype." + memberName + " = function" )
